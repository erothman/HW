...
def get_args():
    ...
    parser.add_argument("--pegasos-lambda", type=float, help="The learning rate for the pegasos algorithm", default=0.0001)
...
def main():
    ...
    if args.mode.lower() == "train":
        ...
        if args.algorithm.lower() == 'useless':
            ...
            model = models.Pegasos(args.pegasos_lambda, args.online_training_iterations)
        else:
